...
class Agent(object):
    def __init__(self, **kwargs):
        ...
        self.actor = Actor(s_dim, [256, 256], a_dim)
        self.actor_target = Actor(s_dim, [256, 256], a_dim)
        self.critic = Critic(s_dim+a_dim, [256, 256])
        self.critic_target = Critic(s_dim+a_dim, [256, 256])
